    ...
    <>
      <Column className="bg-blue_50 font-inter mx-[auto] w-[100%]">
        <Stack className="3xl:h-[1189px] lg:h-[770px] xl:h-[881px] 2xl:h-[991px] w-[96%]">
          ...
          <Row className="absolute items-center justify-center left-[10%] xl:pr-[10px] 2xl:pr-[12px] 3xl:pr-[14px] lg:pr-[9px] top-[10%] w-[13%]">
            <Button
              className="font-medium lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center w-[46%]"
            ...
            <Column className="items-center lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] rounded-radius6 w-[39%]">
              ...
              items={[...Array(6)].map(() => (
                <React.Fragment key={Math.random()}>
                  <Row className="items-center w-[100%]">
                    <List
                      className="gap-[0] grid grid-cols-3 min-h-[auto] w-[63%]"
                    ...
                    >
                      <Column className="w-[100%]">
                        ...
                        <Text className="font-medium lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-gray_903 w-[auto]">
                          18-06-2017 12:38:42
                        </Text>
                        <Button
                        ...
                        <Column className="bg-gray_50 lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] lg:p-[14px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] w-[100%]">
                          <Text className="font-medium mb-[1px] lg:ml-[3px] xl:ml-[4px] 2xl:ml-[5px] 3xl:ml-[6px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-gray_903 w-[auto]">
                            18-06-2017 12:38:42
                          </Text>
                        </Column>
                      </Column>
                      <Line className="self-center w-[37%] lg:mr-[105px] xl:mr-[120px] 2xl:mr-[135px] 3xl:mr-[162px]" />
                      <Column className="w-[100%]">
                        <Column className="bg-gray_50 lg:p-[10px] xl:p-[11px] 2xl:p-[13px] 3xl:p-[15px] w-[100%]">
                          <Text className="font-medium mb-[1px] 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_600 tracking-ls1 uppercase w-[auto]">
                            ID
                        ...
                        <Text className="bg-gray_50 font-normal lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] lg:py-[14px] xl:py-[16px] 2xl:py-[18px] 3xl:py-[21px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_600 w-[158px]">
                          456
                        </Text>
                        <Text className="font-normal lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_600 w-[auto]">
                          789
                      ...
                      <Column className="w-[100%]">
                        ...
                        <Text className="bg-gray_50 font-normal lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] lg:py-[14px] xl:py-[16px] 2xl:py-[18px] 3xl:py-[21px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-blue_A700 w-[112px]">
                          BTC
                        </Text>
                        <Text className="font-normal lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-blue_A700 w-[auto]">
                          BTC
                        ...
                        <Text className="font-normal lg:ml-[22px] xl:ml-[25px] 2xl:ml-[29px] 3xl:ml-[34px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-blue_A700 w-[auto]">
                          {" "}
                          BTC
                        </Text>
                        <Text className="bg-gray_50 font-normal lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] lg:py-[14px] xl:py-[16px] 2xl:py-[18px] 3xl:py-[21px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-blue_A700 w-[112px]">
                    ...
                    <Column className="w-[68%]">
                      <Column className="bg-gray_50 lg:p-[10px] xl:p-[11px] 2xl:p-[13px] 3xl:p-[15px] w-[37%]">
                        <Text className="font-medium mb-[1px] 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_600 tracking-ls1 uppercase w-[auto]">
                          Amount
                        </Text>
                      </Column>
                      <Line className="bg-gray_300 h-[1px] w-[37%]" />
                      <Text className="font-normal lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_600 w-[auto]">
                        4030.40
                      </Text>
                      <Input
                      ...
                      <Column className="bg-gray_50 lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] lg:p-[14px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] w-[37%]">
                        <Text className="font-normal mb-[1px] lg:ml-[3px] xl:ml-[4px] 2xl:ml-[5px] 3xl:ml-[6px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_600 w-[auto]">
                          4030.40
                        </Text>
                      </Column>
                    </Column>
                    <Column className="lg:mr-[105px] xl:mr-[120px] 2xl:mr-[135px] 3xl:mr-[162px] w-[23%]">
                      <Column className="bg-gray_50 lg:p-[10px] xl:p-[11px] 2xl:p-[13px] 3xl:p-[15px] w-[100%]">
                        <Text className="font-medium mb-[1px] 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_600 tracking-ls1 uppercase w-[auto]">
                          TXID
                        </Text>
                    ...
                    <Column className="w-[14%]">
                      ...
                      <Line className="bg-gray_300 h-[1px] w-[100%]" />
                      <Button
                        className="2xl:ml-[24px] 2xl:mt-[16px] 3xl:ml-[28px] 3xl:mt-[19px] flex items-center justify-center lg:ml-[18px] lg:mt-[12px] text-center w-[51%] xl:ml-[21px] xl:mt-[14px]"
                        rightIcon={
                          <Img
                            src="images/img_icon.svg"
                            className="text-center lg:w-[7px] lg:ml-[6px] xl:w-[8px] xl:ml-[7px] 2xl:w-[10px] 2xl:ml-[8px] 3xl:w-[12px] 3xl:ml-[9px]"
                            alt="Icon"
                          />
                        }
                        shape="RoundedBorder8"
                      ...
                      >
                        <div className="bg-transparent font-medium xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px]">
                          Pending
                        </div>
                      </Button>
                      <Column className="bg-gray_50 lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] w-[100%]">
                        <Text className="bg-red_50 font-medium lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] 2xl:px-[10px] 3xl:px-[12px] lg:px-[7px] xl:px-[8px] py-[2px] rounded-radius10 xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-red_900 w-[64px]">
                          Expired
                        </Text>
                      </Column>
                      <Button
                        className="font-medium lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-center w-[41%]"
                        shape="RoundedBorder8"
                        size="sm"
                        variant="FillGreen50"
                      >
                      ...
                      <Column className="bg-gray_50 lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] w-[100%]">
                        <Button
                          className="font-medium lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-center w-[50%]"
                          shape="RoundedBorder8"
                          size="sm"
                          variant="FillGreen50"
                        >
                      ...
                      <Text className="bg-red_50 font-medium lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:pb-[3px] xl:pb-[4px] 2xl:pb-[5px] 3xl:pb-[6px] pt-[2px] 2xl:px-[10px] 3xl:px-[12px] lg:px-[7px] xl:px-[8px] rounded-radius10 xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-red_900 w-[55px]">
                        Failed
                      </Text>
                      <Column className="bg-gray_50 lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] w-[100%]">
                        <Button
